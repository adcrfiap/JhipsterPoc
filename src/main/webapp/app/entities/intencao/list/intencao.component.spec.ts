...
describe('Component Tests', () => {
  describe('Intencao Management Component', () => {
    let comp: IntencaoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IntencaoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.intencaos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
